...
<body>
	<div class="headerBar">
		<div class="logoBar login_logo">
			<div class="comWidth">
				<div class="logo fl">
					<a href="#"><img
						src="${ pageContext.request.contextPath}/images/logo4.png"
						alt="妈，饿了">
					</a>
				</div>
		...
		<div class="loginBox">
			...
			<div class="login_cont">
				<ul class="login">
					...
					<li><input type="submit" value="" class="login_btn">
					</li>
				</ul>
	...
	<div class="footer">
		<p>
			<a href="#">妈，饿了简介</a><i>|</i><a href="#">妈，饿了公告</a><i>|</i> <a href="#">招纳贤士</a><i>|</i><a
				href="#">联系我们</a><i>|</i>客服热线：400-675-1234
		</p>
		<p>Copyright &copy; 2006 - 2014
			妈，饿了版权所有&nbsp;&nbsp;&nbsp;京ICP备09037834号&nbsp;&nbsp;&nbsp;京ICP证B1034-8373号&nbsp;&nbsp;&nbsp;某市公安局XX分局备案编号：123456789123</p>
		<p class="web">
			<a href="#"><img
